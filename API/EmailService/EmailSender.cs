...
namespace EmailService
{
    public class EmailSender : IEmailSender
    {
        ...
        private MimeMessage CreateEmailMessage(Message message)
        {
            ...
            var bodyBuilder = new BodyBuilder { HtmlBody = string.Format("<div class='text-center'><h2 style='color: green; font-size: 24px; font-family:'Times New Roman''><strong>Link do zmiany hasła</strong></h2><br /><img src='https://res.cloudinary.com/duj1ftjtp/image/upload/v1668515462/Watermark_lkvpud.png' style='margin-bottom: 20px;' alt='logo><br /><p style='font-size: 20px; margin-top: 10px;'>{0}</p></div>", message.Content) };
