...
namespace API.Data
{
    public class MessageRepository : IMessageRepository
    {
        ...
        public async Task<IEnumerable<MessageDto>> GetMessages(string recipientUsername, string senderUsername)
        {
                return await _context.Messages
                .IgnoreQueryFilters()
                ...
                .Select(u => new MessageDto
                {
                    ...
                    RecipientUsername = u.RecipientUsername,
                    Content = u.Content,
                    MessageSent = u.MessageSent,
                }).OrderByDescending(u => u.Id)
                .ToListAsync();
        }
    }
